...
<p align="center">
  <a href="./assets/demo/jahiz-mobile-demo.mp4">
    <img src="./assets/hero/jahiz-hero.webp" alt="Watch Jahiz Mobile Demo" width="100%" />
  </a>
  <br />
  <em>▶️ <a href="./assets/demo/jahiz-mobile-demo.mp4"><strong>Click here to download / watch the high-resolution mobile demo video (MP4, 1.05 MB)</strong></a></em>
</p>
...
<p align="center">
  <img src="./assets/diagrams/analytics-pipeline.svg" alt="Asynchronous Analytics Aggregation Pipeline" width="100%" />
</p>
...
<p align="center">
  <img src="./assets/diagrams/match-state-lifecycle.svg" alt="Match State Lifecycle & Transitions" width="100%" />
</p>
...
<table>
  <tr>
    <td width="50%">
      <img src="./assets/screenshots/coach-home.webp" alt="Coach Command Center" /><br />
      <strong>Coach Command Center</strong><br />
      Quick-start match actions, squad readiness metrics, and upcoming tournament schedule.
    </td>
    <td width="50%">
      <img src="./assets/screenshots/live-match-logging.webp" alt="Live Match Logging" /><br />
  ...
  <tr>
    <td width="50%">
      <img src="./assets/screenshots/match-review-history.webp" alt="Match Review & Timeline" /><br />
    ...
    <td width="50%">
      <img src="./assets/screenshots/match-performance-analytics.webp" alt="Performance Analytics" /><br />
  ...
  <tr>
    <td width="50%">
      <img src="./assets/screenshots/coach-team-management.webp" alt="Coach Team Management" /><br />
      <strong>Coach Team Management</strong><br />
      Squad roster management, weight category tracking, and athlete readiness status.
    </td>
    <td width="50%">
      <img src="./assets/screenshots/athlete-profile-management.webp" alt="Athlete Profile Management" /><br />
  ...
  <tr>
    <td width="50%">
      <img src="./assets/screenshots/tournament-workflow.webp" alt="Tournament Workflows" /><br />
      <strong>Tournament Management</strong><br />
      Bracket progression, single-elimination bout routing, and tournament-level reporting.
    </td>
    <td width="50%">
      <img src="./assets/screenshots/athlete-self-profile.webp" alt="Athlete Self Profile" /><br />
...
<p align="center">
  <img src="./assets/diagrams/domain-model.svg" alt="Jahiz Relational Domain Model" width="100%" />
</p>
